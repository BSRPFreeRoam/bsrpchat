window.APP = {
    ...
    mounted() {
        post('https://bsrpchat/loaded', JSON.stringify({}));
    ...
    methods: {
        ...
        warn(msg) {
            this.messages.push({
                args: [msg],
                template: '^3<b>Bad Citizen</b>: ^0{0}',
            });
        },
        ...
        send(e) {
            if (this.message !== '') {
                post('https://bsrpchat/chatResult', JSON.stringify({
        ...
        hideInput(canceled = false) {
            if (canceled) {
                post('https://bsrpchat/chatResult', JSON.stringify({ canceled }));
            }
            this.message = '';
